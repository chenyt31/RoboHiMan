...
def get_eval_parser():
    ...
    parser.add_argument("--tasks_type", type=str, default="atomic")
    parser.add_argument("--eval_mode", type=str, default="vanilla")
    parser.add_argument("--high_level_cfg_path", type=str, default=None)
    return parser
