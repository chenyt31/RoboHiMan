...
if __name__ == "__main__":
    ...
    parser.add_argument("--replay_dir", type=str, default="HiMan_data/replay/replay_train_with_goal_lang_t5") # modify
    parser.add_argument("--data_dir", type=str, default="HiMan_data") # modify
