...
uv pip install torch torchvision torchaudio --index-url https://download.pytorch.org/whl/cu118 # modify
uv pip install -U xformers --index-url https://download.pytorch.org/whl/cu118 # modify
...
--device 0  \
--log-dir path_to_save_file \ # modify, e.g. HiMan_Data/train_logs_baseline_rvt_half
--replay_dir path_to_save_file \ # modify, e.g. HiMan_Data/replay/replay_train_baseline_rvt_half
--data_dir path_to_data \ # modify, e.g. HiMan_Data/L1
--train_mode "half"
...
bash eval.sh \
  --epoch last \
  --model_folder path_to_ckpt \ # modify, e.g. HiMan_Data/RVT-Baseline-Ckpt/less_L1_half/rvt2
  --device 0 \
  --tasks_type atomic \
  --eval_mode vanilla \
  --data_dir path_to_data \ # modify, e.g. HiMan_Data/test_atomic
  --num_episodes 5 \
  --log_name "atomic_vanilla"

bash eval.sh \
  --epoch last \
  --model_folder path_to_ckpt \ # modify, e.g. HiMan_Data/train_logs_baseline_rvt_half/rvt2
  --device 0 \
  --tasks_type atomic \
  --eval_mode half \
  --data_dir path_to_data \ # modify, e.g. HiMan_Data/test_atomic
  --num_episodes 5 \
  --log_name "atomic_half"
...
bash eval.sh \
  ...
  --num_episodes 5 \
  --log_name "compositional_vanilla"
