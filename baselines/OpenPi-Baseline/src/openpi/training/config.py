...
_CONFIGS = [
    ...
    *roboarena_config.get_roboarena_configs(),
    ...
    #
    TrainConfig(
        name="openpi_baseline_low_mem_finetune",
        model=pi0.Pi0Config(paligemma_variant="gemma_2b_lora", action_expert_variant="gemma_300m_lora"),
        data=LeRobotRLBenchDataConfig(
            repo_id="openpi_baseline_less_L1",
            base_config=DataConfig(
                prompt_from_task=True,
            ),
        ),
    ...
    TrainConfig(
        name="openpi_baseline_less_L1_half",
        model=pi0.Pi0Config(),
        data=LeRobotRLBenchDataConfig(
            repo_id="openpi_baseline_less_L1_half",
            base_config=DataConfig(
                prompt_from_task=True,
            ),
        ),
    ...
    TrainConfig(
        name="openpi_baseline_less_L2_half",
        model=pi0.Pi0Config(),
        data=LeRobotRLBenchDataConfig(
            repo_id="openpi_baseline_less_L2_half",
            base_config=DataConfig(
                prompt_from_task=True,
            ),
        ),
    ...
    TrainConfig(
        name="openpi_baseline_less_L3_half",
        model=pi0.Pi0Config(),
        data=LeRobotRLBenchDataConfig(
            repo_id="openpi_baseline_less_L3_half",
            base_config=DataConfig(
                prompt_from_task=True,
            ),
        ),
    ...
    TrainConfig(
        name="openpi_baseline_less_L4_half",
        model=pi0.Pi0Config(),
        data=LeRobotRLBenchDataConfig(
            repo_id="openpi_baseline_less_L4_half",
            base_config=DataConfig(
                prompt_from_task=True,
            ),
        ),
